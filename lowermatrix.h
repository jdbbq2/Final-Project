...
////////////////////////////////////////////////////////////////
// Class: lowerMatrix                                            //
// Purpose: The lowerMatrix class models a mathematical matrix.  //
...
//          represents a lower diagonal filled or nearly      //
//          filled. It only stores the lower diagonal so it   //
...
////////////////////////////////////////////////////////////////
//Function:     lowerMatrix();                                //
//              lowerMatrix(const lowerMatrix& cpy);          // 
//Precondition: cpy must be square matrix (NxN)               //
//Postcondition: an object of type lowerMatrix is created     //
//               default size of 0 for dimentions             //
//Description: constructors for lowerMatrix, copy constructor //
...
//               deallocated                                  //
//Description: destructor for lowerMatrix                     //
////////////////////////////////////////////////////////////////


////////////////////////////////////////////////////////////////////////////////
//Function:    lowerMatrix<T>& operator =(const lowerMatrix<T>& source);      //
//                                                                            //
...
///////////////////////////////////////////////////////////////////////////////
//Function:   lowerMatrix<T> operator +(const lowerMatrix<T>& rhs) const;    //
//            lowerMatrix<T> operator +(const upperMatrix<T>& rhs) const;    //
...
/////////////////////////////////////////////////////////////////////////////
//Function:      lowerMatrix<T> operator *(const T rhs) const;             //
...
//Precondition: indicex should be in matrix                                       //
...
//                over diagonal the literal 0 is returned and no access is made)  //
...
//                then will create a matrix with the lower diagonal//
//                REGARDLESS of what was in the upper diagonal    //
////////////////////////////////////////////////////////////////////
...
template <typename T>
class lowerMatrix : public myMatrix<T>
{
  public:
    lowerMatrix();
    lowerMatrix(const lowerMatrix& cpy);
    ...
    lowerMatrix<T>& operator =(const lowerMatrix<T>& rhs);
